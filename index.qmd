...
Transitions between, and out of, the $S$ states in the absence of any colonized patients: $$
S = \left(
\begin{matrix}
    -s_{21}-\omega_1 & s_{12} \\
    s_{21} & -s_{12}-\omega_2
...
\begin{matrix}
    ...
    \theta_2
\end{matrix}\right)
$$ Moment-generating function associated with the time-of-stay-dependent removal hazard: $$ M(t) $$
